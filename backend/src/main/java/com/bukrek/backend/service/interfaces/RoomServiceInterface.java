...
public interface RoomServiceInterface {
    ...
    Response addNewRoom(MultipartFile photo, String roomType,
    ...
    Response updateRoom(Long roomId, String description,
                        String roomType, BigDecimal roomPrice, MultipartFile photo);
